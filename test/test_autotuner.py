...
class TestPerfStatsGating(TestCase):
    ...
    Stats are delivered only through an
    ...
    # --- off-path uses return_mode="median", builds no PerfStats ----
    ...
    # --- on-path collects PerfStats through the collector -----------
    ...
    # --- subprocess path mirrors the off/on contract ---------
    ...
    # --- benchmark() leaves perf_stats None on every off-path result -
